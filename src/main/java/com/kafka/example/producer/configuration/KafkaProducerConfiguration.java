package com.kafka.example.producer.configuration;
...
public class KafkaProducerConfiguration {
    ...
    public ProducerFactory<String, Notification> producerFactory() {
        ...
        return new DefaultKafkaProducerFactory<>(configProps, new StringSerializer(), new JsonSerializer<Notification>());
    }
